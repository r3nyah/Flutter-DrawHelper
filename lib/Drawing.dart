...
const APP_UI_COLOR_SECONDARY = Color(0xB29700);
...
class DrawingPageState extends State<DrawingPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (_lines.isNotEmpty) return await h.showConfirmDialog(
            "Are you sure you want to discard this drawing?",
